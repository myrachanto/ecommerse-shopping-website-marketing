...
<style scoped>
.container {
@apply h-96 flex justify-between items-center text-center mx-auto;
}
.main3{
  @apply container text-justify py-6 flex flex-wrap px-5;
}
.chantos{
  @apply text-gray-300;
}
.conta{
  @apply w-full my-2 text-5xl font-bold leading-tight text-center text-white;
}
.war{
  @apply w-full mb-4;
}
