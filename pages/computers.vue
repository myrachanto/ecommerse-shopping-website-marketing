<template>
  <div class="cont">
     ...
     <section class="section mt-16">
      <div class="s-head">All products</div>
  ...
  data () {
    return {
      items: [
        {
          id: 1,
          picture: `${require('~/assets/imgs/products/desktop1.jpeg')}`,
          oldprice: 2500,
          newprice: 2300,
          title: 'Mac desktop',
          alt: 'Mac desktop',
        ...
        {
          id: 2,
          picture: `${require('~/assets/imgs/products/desktop2.jpeg')}`,
          oldprice: 2000,
          newprice: 1800,
          title: 'Mac desktop 2',
          alt: 'Mac desktop 2',
        ...
        {
          id: 3,
          picture: `${require('~/assets/imgs/products/destop3.jpeg')}`,
          oldprice: 3000,
          newprice: 2700,
        ...
        {
          id: 4,
          picture: `${require('~/assets/imgs/products/desktop4.jpeg')}`,
          oldprice: 3000,
          newprice: 2700,
          title: 'Desktop apple ',
          alt: 'Desktop apple',
